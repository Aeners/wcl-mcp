    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          start_time_s: { type: 'number', description: 'Window start, in seconds since the pull (single fight only)' },
          end_time_s: { type: 'number', description: 'Window end, in seconds since the pull (single fight only)' },
        },
        required: ['report_code', 'fight_ids'],
      },
    },
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          start_time_s: { type: 'number', description: 'Window start, in seconds since the pull' },
          end_time_s: { type: 'number', description: 'Window end, in seconds since the pull' },
